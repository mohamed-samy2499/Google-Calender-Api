...
namespace CalenderSystem.Application.Feature.Events.Commands.Validators
{
    ...
    {
        public UpdateEventValidator() { ApplyValidationsRules(); }
        public void ApplyValidationsRules()
        {
            RuleFor(x => x.Id)
                .NotEmpty().WithMessage("Id can't be Empty")
                .NotNull().WithMessage("Id is Required");
            RuleFor(x => x.GoogleCalendarEventId)
                .NotEmpty().WithMessage("GoogleCalendarEventId can't be Empty")
                .NotNull().WithMessage("GoogleCalendarEventId is Required");
            RuleFor(x => x.Summary)
